...
export class CustomerService {
  ...
  addNewCustomer(newCustomer: Customer): Observable<number> {
    return this._http.post<any>(this.baseUrl, newCustomer).pipe(tap(() => this.setAllCustomers()))
  }
  updateCustomer(customerToUpdate: Customer): Observable<any> {
    return this._http.put(this.baseUrl + customerToUpdate.id, customerToUpdate).pipe(tap(() => this.setAllCustomers()))
  }
  deleteCustomer(id: number): Observable<any> {
    return this._http.delete(this.baseUrl + id).pipe(tap(() => this.setAllCustomers()))
  }
}